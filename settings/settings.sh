...
DNS_LABEL_NAME="oasis-enterprise-dev-tester"

DNS_LABEL_NAME="oasis-enterprise-dev-tester"
# Email to use for letsencrypt certificates
LETSENCRYPT_EMAIL="rodney.effah@oasislmf.org"

# Name of the resource group to deploy to
RESOURCE_GROUP="oasis-enterprise-dev-tester"
...
OASIS_PLATFORM_DIR=/home/rodney/Documents/NEW-OasisLMF/OasisPlatform

# Set to override path to OasisLMF/OasisPiWind repository
OASIS_PIWIND_DIR=/home/rodney/Documents/NEW-OasisLMF/OasisPiWind
